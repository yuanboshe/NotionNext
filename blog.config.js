...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    '我是一个机器人软件系统架构师，, 我曾经当过程序员，喜欢软件开发，, 我创过业，自己当老板浪费了几千万，差点自挂东南枝，, 我最终对自己的人生有所领悟，记录在这里！',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'yuanboshe', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个有道心的机器人软件系统架构师', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.pz1.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'yuanboshe,ROS,ROS2,AMR', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'yuanboshe@yeah.net', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/yuanboshe', // 你的github个人主页 例如 https://github.com/tangly1024
